...
1. **Start Main Pizza Website**: Double-click `start.bat`
   - Opens main website at `http://localhost:5174`
2. **Start Admin Dashboard**: Double-click `start-admin.bat`
   - Opens admin dashboard at `http://localhost:5002`
...
- Any email (e.g., priyanshu@example.com)
- Any password
...
1. **Username Display**: Now shows actual login name (e.g., "Priyanshu" from priyanshu@example.com)
